/*
            Завдання:
            Перепишіть код таким чином, щоб він не змінив своєї поведінки, але результат роботи сценарію виводився не в консоль а у відповідні р.
            
            Електронні адреси користувачів (кожна адреса з нового рядка) - параграф з id emailAddressesOutput
            Користувач з найбільшою кількістю друзів (кожен користувач з нового рядка) - параграф з id greatesFriendsCountOutput
            Компанії користувача з найбільшим балансом - параграф з id greatestBalanceCompanyOutput
            Компанії користувача з найменшим балансом - параграф з id lowestBalanceCompanyOutput
            */
            // масив згенерований за допомогою https://next.json-generator.com/
            let users = [
                {
                    balance: '1250.89',
                    age: 24,
            ...
            function showAllEmails() {
                ...
                users.forEach(user => emails.innerHTML += user.email + '<br>');
            }
            ...
            function showHigestFriendCount() {
                ...
                users
                    ...
                    .forEach(user => friends.innerHTML += user.name.first + " " + user.name.last + '<br>');
            }
            ...
            function showMinMaxBalance() {
                ...
                users
                    ...
                    .forEach(user => richer.innerHTML += user.company);

                //console.log("Компанії користувачів з найменшим балансом:")
                users
                    .filter(user => user.balance == minBalance)
                    .forEach(user => poorer.innerHTML += user.company);
            }
            let emails = document.querySelector('#emailAddressesOutput')
            let friends = document.querySelector('#greatesFriendsCountOutput')
            let richer = document.querySelector('#greatestBalanceCompanyOutput')
            let poorer = document.querySelector('#lowestBalanceCompanyOutput')
            showAllEmails();
