/*
        Завдання:
        Внесіть зміни в даний код.
        Картка користувача, кількість друзів якого не перевищує 5 (значення розміру масиву friends в об'єктах масиву users), повинна відображатися з червоною рамкою, товщиною в 2px.
        */
        ...
        function createUserCard(user) {
            ...
            if(user.friends.length < 5) div.style.border = '2px solid red'
